...
const UserBoardList = (props) => {
    ...
    const loadBoardList = async(boardKind) => {
        ...
        let url;
        if(boardKind === 0){
            url = `/api/boardPlay/${props.match.params.userId}`;
        }else if(boardKind === 1){
            url = `/api/boardGram/${props.match.params.userId}/${cookies.userKey}`;
        }else if(boardKind === 2){
            url = `/api/boardColumn/${props.match.params.userId}`;
        }
