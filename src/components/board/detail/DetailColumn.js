...
const DetailColumn = (props) => {
    ...
    useEffect(()=>{
        const loadColumn = async() => {
            ...
            await axios.get(`/api/boardColumn/${props.match.params.boardId}/${cookies.userKey}`, config).then((response)=>{
        ...
        <>
            <div className="board_detail">
                <div className="board_detail_title">
                    <div className="board_detail_kind">전문가 칼럼 <FontAwesomeIcon icon={faAngleDoubleRight} /> {value.sportName}</div>
                    ...
                    <div className="board_detail_follow">
                        ...
                        :
                        <>
                            <button className="update" onClick={() => props.history.push(`/board/5/${value.boardNo}/update`)}>수정</button>
                ...
                <div className="board_detail_play_content_body">
                    <div className="board_detail_play_img" id={`img${i}`} onClick={handleClickImg} accessKey={i} style={{backgroundImage: boardDetail.boardImage ? `url('${boardDetail.boardImage}')` : null}}>
                            ...
                            <>
                                ...
                                >
                                    <Grid item container justify="space-between">
                                        ...
                                        <Grid item xs={8}>
                                            <div>
                                                <div className="otherGoods_view_goodsTitle">{boardGoods.name}</div>
                                                <div className="otherGoods_view_goodsLink">&gt;</div>
                                            </div>
                                            <div className="otherGoods_view_goodsManufacturer">
                                                {boardGoods.manufacturer}
                                            </div>
                                            <div className="otherGoods_view_price">
                                                50000~
                                            </div>
                                        </Grid>
                        ...
                        <div className="view_goods_btn" onClick={handleClickImg} accessKey={i} style={{bottom: `10px`, right: `10px`}}><FontAwesomeIcon icon={faTag} /> 상품 보기</div>:
                        null
                        }
                    </div>
                ...
                <br/>
                <div className="board_detail_column_comment">
                    <button className="board_create_form" onClick={props.handleClickOpen}>글이 얼마나 도움이 되셨나요?</button>
                </div>
