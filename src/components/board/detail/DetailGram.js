...
const DetailGram = (props) => {
    ...
    useEffect(()=>{
        const loadGram = async() => {
            ...
            await axios.get(`/api/boardGram/detail/${props.match.params.boardId}/${cookies.userKey}`, config).then((response)=>{
                setLoading(true);
                setTimeout(() => {
...
export default withRouter(DetailGram);