...
const BoardGramEtc = (props) => {
    ...
    const handleClickDelete = () => {
        closeSnackbar();
        props.handleClickCardValue(props.contentKey,'board_delete');
    }
    const handleClickShare = () => {
        ...
        setTimeout(() => {
            ...
            const text    = `${window.location.origin}/board/3/${props.value.board_no}`;
    ...
    const handleClickFollow = () => {
        props.handleClickCardValue(props.contentKey, 'user_follow');
    }
    ...
    return (
        ...
        <Drawer anchor="bottom" open={open} style={{zIndex: '1501'}} onClose={handleClose} onClick={handleClose}>
            ...
            >
                {props.value.user_no === props.user.user_no ?
                <List>
                    <ListItem button onClick={() => props.history.push(`/board/3/${props.value.board_no}/update`)}>
                ...
                <List>
                    ...
                    {props.value.user_follow ? 
                    <ListItem button onClick={handleClickFollow}>
